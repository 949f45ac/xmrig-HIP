...
#define ALGOMEM (xmrig::cn_select_memory<ALGO>() >> 4)

#define BASE_OFF(thread, threads) (thread / sec_size0) * sec_size0 * ALGOMEM + over * ((thread-nshift_limit_t) / sec_size1) * sec_size1 * ALGOMEM + (thread % sec_size1) * CHU;
