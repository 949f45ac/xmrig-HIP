...
static inline __m128i sqrt_v2_single_precision(const uint64_t n0)
{
	const __m128 z = _mm_setzero_ps();
	return _mm_cvtsi64_si128(((uint32_t) ((n0 >> 41) + ((64U + 127U) << 23))));
